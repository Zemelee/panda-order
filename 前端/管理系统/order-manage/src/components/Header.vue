  ...
  <div>
    ...
    >
      ...
      <el-menu-item index="/Record"
        ><a href="/Record" style="text-decoration: none" target=""
          >订单记录</a
        ></el-menu-item
      >
      <el-menu-item index="/LoginLog"
        ><a href="/LoginLog" style="text-decoration: none" target=""
          >登录日志</a
        ></el-menu-item
      >
      <el-submenu index="5">
...
export default {
  ...
  mounted() {
    this.setActiveIndex(); // 初始化菜单项的激活状态
    this.$router.afterEach(this.setActiveIndex); // 监听路由变化
  },
  methods: {
    handleClick(event) {
